...
export function Sidebar() {
  ...
  return (
    <aside className="surface-glass sticky top-0 hidden h-dvh w-60 shrink-0 flex-col overflow-y-auto border-r-0 lg:flex">
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="mx-5 mb-4 mt-4 rounded-xl border border-white/10 bg-black/20 px-3 py-3 text-[11px] leading-relaxed text-dim">
        ...
        return (
          ...
          >
            <span
              aria-hidden
              className={clsx(
                "grid h-7 w-7 place-items-center rounded-lg border text-sm transition-colors",
                active ? "border-pitch/30 bg-pitch/15" : "border-white/5 bg-black/15 hover:border-white/10 hover:bg-white/5",
              )}
            >
              {item.icon}
            </span>
